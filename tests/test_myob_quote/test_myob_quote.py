...
class Test_MYOB_Quotes():
    ...
    def test_myob_quotes_ui_001(self,myob_quote):
        """Verify the URL"""
        assert myob_quote.check_myob_url == "https://test_sample"

    def test_myob_quotes_ui_002(self,myob_quote):
        """Verify the title"""
        assert myob_quote.check_myob_title == "test_sample"

    def test_myob_quotes_ui_003(self,myob_quote):
        """Verify client details section"""
        assert myob_quote.check_client_details == ("test_sample","test_sample","test_sample")
    ...
    def test_myob_quotes_ui_005(self,myob_quote):
        ...
        assert myob_quote.check_quote_info == ("test_sample", "test_sample", "test_sample")
