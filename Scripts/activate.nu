...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Yi Sun\PycharmProjects\EGD_Dev_Playwright_Pytest_GIT'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Yi Sun\PycharmProjects\EGD_Dev_Playwright_Pytest_GIT\Scripts\deactivate.nu'
